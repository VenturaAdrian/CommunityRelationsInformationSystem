...
var Drawer = React5.forwardRef(function Drawer2(inProps, ref) {
  ...
  const drawer = (0, import_jsx_runtime4.jsx)(DrawerPaper, {
  ...
  if (variant === "permanent") {
    return (0, import_jsx_runtime4.jsx)(DrawerDockedRoot, {
  ...
  const slidingDrawer = (0, import_jsx_runtime4.jsx)(TransitionComponent, {
    in: open,
  ...
  return (0, import_jsx_runtime4.jsx)(DrawerRoot, {
    BackdropProps: {
      ...BackdropProps,
      ...BackdropPropsProp,
      transitionDuration
...
//# sourceMappingURL=chunk-GP3P2JZW.js.map
